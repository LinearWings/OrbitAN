...
export const METHODOLOGIES: MethodologyType[] = [
  {
    ...
    description: "五阶段工作流：收集 → 整理 → 组织 → 回顾 → 执行",
  ...
  },
  {
    ...
    name: "番茄钟",
    nameEn: "Pomodoro",
    description: "25分钟专注 + 5分钟休息，4轮后长休息",
  ...
  },
  {
    ...
    description: "识别 20% 的关键任务，产生 80% 的成果",
  ...
  },
  {
    ...
    description: "紧急/重要四象限分类，优先处理核心任务",
