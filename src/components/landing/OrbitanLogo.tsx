...
export function OrbitanLogo({ variant = "hero" }: LogoProps) {
  ...
  return (
    <div className={isHero ? "l-logo-hero" : "l-logo-nav"} aria-label="OrbitAN" role="img">
      <style>{`
        @keyframes logo-ring-spin { from { transform: rotate(-15deg); } to { transform: rotate(345deg); } }
        @keyframes logo-ring-counter { from { transform: rotate(38deg); } to { transform: rotate(398deg); } }
        @keyframes logo-planet-pulse { 0%,100% { opacity: 0.55; } 50% { opacity: 0.85; } }
        @keyframes logo-shimmer { 0% { stop-color: #60A5FA; stop-opacity: 1; } 50% { stop-color: #93C5FD; stop-opacity: 0.9; } 100% { stop-color: #60A5FA; stop-opacity: 1; } }
        @keyframes logo-star-twinkle { 0%,100% { opacity: 0.15; } 50% { opacity: 0.5; } }
        .l-logo-ring-primary { animation: logo-ring-spin 60s linear infinite; transform-origin: 46px 60px; }
        .l-logo-ring-secondary { animation: logo-ring-counter 80s linear infinite; transform-origin: 46px 60px; }
        .l-logo-planet-glow { animation: logo-planet-pulse 4s ease-in-out infinite; }
        .l-logo-star { animation: logo-star-twinkle 3s ease-in-out infinite; }
      `}</style>
      <svg viewBox={isHero ? "-17 0 300 130" : "0 0 520 130"} fill="none" xmlns="http://www.w3.org/2000/svg" className="l-logo-svg" style={{ width: "100%", height: "auto" }}>
        <defs>
          ...
          <filter id="lg-glow" x="-300%" y="-300%" width="700%" height="700%"><feGaussianBlur in="SourceGraphic" stdDeviation="12"/></filter>
        ...
        {/* ── BACKGROUND STARFIELD (inside the O) ── */}
        <g clipPath="url(#lg-o-clip)" opacity="0.6">
          <circle cx="30" cy="30" r="0.6" fill="#fff" className="l-logo-star" style={{ animationDelay: "0s" }}/>
          <circle cx="58" cy="25" r="0.4" fill="#fff" className="l-logo-star" style={{ animationDelay: "1.2s" }}/>
          <circle cx="22" cy="70" r="0.5" fill="#fff" className="l-logo-star" style={{ animationDelay: "0.6s" }}/>
          <circle cx="65" cy="80" r="0.3" fill="#fff" className="l-logo-star" style={{ animationDelay: "2s" }}/>
          <circle cx="40" cy="50" r="0.4" fill="#93C5FD" className="l-logo-star" style={{ animationDelay: "0.8s" }}/>
          <circle cx="55" cy="55" r="0.35" fill="#FBBF24" className="l-logo-star" style={{ animationDelay: "1.5s" }}/>
          <circle cx="35" cy="85" r="0.45" fill="#fff" className="l-logo-star" style={{ animationDelay: "2.5s" }}/>
          <circle cx="60" cy="40" r="0.3" fill="#C4B5FD" className="l-logo-star" style={{ animationDelay: "0.3s" }}/>
        </g>
        ...
        {/* Primary ring: blue gradient, slowly rotating */}
        <g className="l-logo-ring-primary">
          <ellipse cx="46" cy="60" rx="30" ry="35" fill="none" stroke="url(#lg-ring)" strokeWidth="3.5"/>
          {/* Ring edge highlight */}
          <ellipse cx="46" cy="60" rx="30" ry="35" fill="none" stroke="rgba(147,197,253,0.12)" strokeWidth="0.5" strokeDasharray="2 8"/>
        </g>

        {/* Secondary ring: violet, counter-rotating */}
        <g className="l-logo-ring-secondary">
          <ellipse cx="46" cy="60" rx="21" ry="26" fill="none" stroke="url(#lg-ring-violet)" strokeWidth="1.4" strokeDasharray="9 11"/>
        </g>
        ...
        <path d="M34 34 A32 37 0 0 1 56 27" fill="none" stroke="#FDE68A" strokeWidth="0.6" strokeLinecap="round" transform="rotate(-15 46 60)" opacity="0.4"/>
        ...
        {/* Atmospheric halo */}
        <circle cx="62" cy="37" r="18" fill="url(#lg-halo)" className="l-logo-planet-glow"/>
        {/* Outer glow layers */}
        ...
        <text x="146" y="72" fontFamily="'Clash Display', sans-serif" fontWeight="700" fontSize="42" fill="#F59E0B" letterSpacing="-0.5">
          A
          <tspan fill="#FDE68A" opacity="0.3" dx="-0.3" dy="-0.3" fontSize="42">A</tspan>
        </text>
        ...
        <line x1="62" y1="78" x2="225" y2="78" stroke="url(#lg-ring)" strokeWidth="0.3" opacity="0.3"/>

        {/* ── TAGLINE ── */}
        {isHero && (<>
          <text x="135" y="100" fontFamily="'JetBrains Mono', monospace" fontWeight="400" fontSize="5.5" fill="rgba(255,255,255,0.15)" letterSpacing="3" textAnchor="middle">ORBITAL · SCHEDULE · SYSTEM</text>
